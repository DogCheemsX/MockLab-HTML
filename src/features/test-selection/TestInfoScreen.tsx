        ...
        <div className="lg:col-span-7 flex flex-col items-start gap-5">
          ...
          <div className="w-full text-left space-y-3.5">
                ...
                <div
                  ...
                  className={`w-full rounded-2xl p-4 sm:p-5 text-left flex flex-col sm:flex-row sm:items-center justify-between gap-4 cursor-pointer relative overflow-hidden transition-all duration-300 group ${
                    isLocked
                      ...
                      : isFree
                      ? 'glass-panel bg-gradient-to-r from-emerald-950/40 via-slate-900/95 to-teal-950/40 border-2 border-emerald-400/80 shadow-[0_0_25px_rgba(16,185,129,0.25)] hover:border-emerald-300 hover:shadow-[0_0_35px_rgba(16,185,129,0.4)] hover:scale-[1.015]'
                  ...
                  <div className="flex items-start sm:items-center gap-3.5">
                    <div
                      className={`w-11 h-11 rounded-2xl flex items-center justify-center font-black text-lg shrink-0 border transition-transform group-hover:scale-105 ${
                        isLocked
                          ...
                          : isFree
                          ? 'bg-gradient-to-br from-emerald-400 to-teal-500 text-slate-950 border-emerald-300 shadow-glow-emerald'
                    ...
                    <div>
                      <div className="flex items-center gap-2 flex-wrap mb-1">
                        <h4 className={`font-black text-base sm:text-lg transition-colors ${isFree ? 'text-white group-hover:text-emerald-300' : 'text-white'}`}>
                          {instance.title}
                        </h4>
                          ...
                          <span
                            className={`text-[10px] font-black px-2.5 py-0.5 rounded-full border uppercase tracking-wider ${
                              isLocked
                                ...
                                : 'bg-emerald-500 text-slate-950 border-emerald-400 shadow-glow-emerald animate-pulse'
                            }`}
                          >
                            {instance.badgeText}
                          </span>
                    ...
                    <button
                      ...
                      className={`text-xs font-black py-3 px-5 rounded-xl transition-all shadow-md flex items-center gap-1.5 ${
                        isLocked
                          ...
                          : isFree
                          ? 'bg-gradient-to-r from-emerald-500 via-teal-500 to-emerald-600 hover:from-emerald-400 hover:to-teal-400 text-slate-950 border border-emerald-300 shadow-glow-emerald transform hover:scale-105 active:scale-95'
                          : 'bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 text-slate-950 border border-amber-300/60 shadow-glow-amber'
                      }`}
                    >
            ...
            {!isUserPremium && (
              <div
                onClick={() => setIsPremiumModalOpen(true)}
                className="w-full rounded-2xl p-4 sm:p-5 text-left flex flex-col sm:flex-row sm:items-center justify-between gap-4 cursor-pointer relative overflow-hidden transition-all duration-300 group glass-panel bg-gradient-to-r from-amber-950/40 via-purple-950/40 to-slate-900/90 border-2 border-dashed border-amber-400/60 hover:border-amber-300 shadow-glow-amber hover:scale-[1.015]"
              >
                <div className="flex items-start sm:items-center gap-3.5">
                  <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-amber-400 to-yellow-500 text-slate-950 flex items-center justify-center font-black text-lg shrink-0 border border-amber-300 shadow-glow-amber group-hover:scale-105 transition-transform">
                    👑
                  </div>

                  <div>
                    <div className="flex items-center gap-2 flex-wrap mb-1">
                      <h4 className="font-black text-base sm:text-lg text-white group-hover:text-amber-300 transition-colors">
                        + 20 More Full Length Past Papers Available
                      </h4>
                      <span className="text-[10px] font-black px-2.5 py-0.5 rounded-full bg-amber-500/20 text-amber-300 border border-amber-400/50 uppercase tracking-widest">
                        PRO UNLOCK
                      </span>
                    </div>
                    <p className="text-xs text-slate-300 leading-relaxed font-medium">
                ...
                <div className="flex items-center justify-end gap-3 shrink-0">
                  <button
                    ...
                    className="text-xs font-black py-3 px-5 rounded-xl bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-500 hover:from-amber-300 hover:to-yellow-300 text-slate-950 border border-amber-200 shadow-glow-amber transition-all transform hover:scale-105 active:scale-95 flex items-center gap-1.5"
                  >
            ...
            {isUserPremium && (
              <div
                onClick={handleStartFreshSimulation}
                className="w-full rounded-2xl p-4 sm:p-5 text-left flex flex-col sm:flex-row sm:items-center justify-between gap-4 cursor-pointer relative overflow-hidden transition-all duration-300 group glass-panel bg-gradient-to-r from-indigo-950/40 via-slate-900/90 to-emerald-950/40 border-2 border-indigo-400/70 hover:border-indigo-300 shadow-glow-indigo hover:scale-[1.015]"
              >
                <div className="flex items-start sm:items-center gap-3.5">
                  <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-indigo-500 to-emerald-400 text-white flex items-center justify-center font-black text-lg shrink-0 border border-indigo-300 shadow-glow-indigo group-hover:scale-105 transition-transform">
                    ✨
                  </div>

                  <div>
                    <div className="flex items-center gap-2 flex-wrap mb-1">
                      <h4 className="font-black text-base sm:text-lg text-white group-hover:text-indigo-300 transition-colors">
                        + Generate Unlimited On-Demand Past Papers
                      </h4>
                      <span className="text-[10px] font-black px-2.5 py-0.5 rounded-full bg-emerald-500/20 text-emerald-300 border border-emerald-400/50 uppercase tracking-widest shadow-sm">
                        PRO UNLIMITED
                      </span>
                    </div>
                    <p className="text-xs text-slate-300 leading-relaxed font-medium">
                ...
                <div className="flex items-center justify-end gap-3 shrink-0">
                  ...
                  <button
                    ...
                    className="text-xs font-black py-3 px-5 rounded-xl bg-gradient-to-r from-indigo-500 via-indigo-600 to-emerald-500 hover:from-indigo-400 hover:to-emerald-400 text-white border border-indigo-300/50 shadow-glow-indigo transition-all transform hover:scale-105 active:scale-95 flex items-center gap-1.5"
                  >
